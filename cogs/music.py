    ...
    async def play(self, interaction: discord.Interaction, query: str = None):
        ...
        # Mode 2: Search/URL
            ...
            try:
                ...
                with yt_dlp.YoutubeDL(self.get_ytdl_opts()) as ydl:
                ...
                if is_playing:
                    ...
                    self.music_queues[guild_id].insert(0, song)
                    songs_added = 1
                    await interaction.followup.send(f"✅ Queued: **{song['title']}**")

            except Exception as e: return await interaction.followup.send(f"❌ Error: {e}")
